...
In conclusion, we were able to construct two models: (i) predict the salary and (ii) find job recommendations for a hypothetical job-seeker. These models are preliminary and could be enhanced with more data, a different way of handling imputation. 