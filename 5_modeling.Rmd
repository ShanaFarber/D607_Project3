...
colnames(jobs_skills_matrix) <- str_replace_all(colnames(jobs_skills_matrix),
                                                ' ', '_')
...
Save matrix and model for use in Shiny app.

```{r}
saveRDS(rf, 'salary_prediction/salary_rf.rds')
write_csv(jobs_skills_matrix, 'salary_prediction/jobs_skills_matrix.csv')
```