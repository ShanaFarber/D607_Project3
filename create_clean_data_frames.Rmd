...
```{r write-csvs eval=F}
write.csv(job_listings, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/job_listings.csv", row.names=F)

write.csv(skills, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/skills.csv", row.names=F)
```
