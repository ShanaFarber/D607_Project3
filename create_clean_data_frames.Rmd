...
```{r write-csvs}
# csvs for jobs data frames
write.csv(ai_jobs_cleaned, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/ai_jobs.csv", row.names=F)
write.csv(usa_jobs_cleaned, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/usa_jobs.csv", row.names=F)
write.csv(nyc_jobs_cleaned, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/nyc_jobs.csv", row.names=F)

# csvs for skills data frames
write.csv(ai_jobs_skills, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/ai_jobs_skills.csv", row.names=F)
write.csv(usa_jobs_skills, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/usa_jobs_skills.csv", row.names=F)
write.csv(nyc_jobs_skills, "C:/Users/Shoshana/Documents/CUNY SPS/D607_Project3/output/nyc_jobs_skills.csv", row.names=F)
```
