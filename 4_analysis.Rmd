...
data_scientist_top10 %>%
  ggplot(aes(y = reorder(skill, n), x = n, fill = f_color)) +
    geom_bar(stat = "identity") +
    labs(title = "Top 10 Skills for Data Scienctists", x = "Count") +
    theme_bw() +
    theme(legend.position = "none") +
...
data_analyst_top10 %>%
  ggplot(aes(y = reorder(skill, n), x = n, fill = f_color)) +
    geom_bar(stat = "identity") +
    labs(title = "Top 10 Skills for Data Analysts", x = "Count") +
    theme_bw() +
    theme(legend.position = "none") +
    scale_fill_manual(values = c("Yes" = "#F28E2B", "No" = "gray")) +
    geom_text(aes(label = n), 
...
ggplot(import_df, aes(x = highest_ed, fill = continent)) +
  geom_bar() +
